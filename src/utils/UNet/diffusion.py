...
from utils.ATTENTION.attention import SelfAttention, CrossAttention
...
class TimeEmbedding(nn.Module):
    ...
    def __init__(self, n_embd: int):
        ...
        self.layer_1 = nn.Linear(4 * n_embd, 4 * n_embd)
...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x, context):
        ...
        # normalisation + Feed-forward with GeGLU with skip connection
        residue_short = x
...
class UNET(nn.Module):
    ...
    def __init__(self):
        ...
        self.decoder = nn.ModuleList([
            SwitchSequential(UNET_ResidualBlock(2560, 1280)), #2 * 1280 = 2560; this is because bottleneck output is 1280 + skip connection from encoder another 1280
